...
module.exports = function(projectName) {
  return {
    helloYeti: [
      'Thanks for using Bootstrap CLI!',
      '-------------------------------------------',
    ...
    gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the Bootstrap template.\nMake sure your computer's Git is configured properly and then try again.",
    ...
    installSuccessFinal: "\nNow run " + "bootstrap watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "bootstrap watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
